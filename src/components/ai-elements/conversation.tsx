...
export const ConversationEmptyState = ({
  ...
  >
    {children ?? (
      <>
        {icon && <div className="midday-text-muted">{icon}</div>}
        <div className="space-y-1">
          <h3 className="font-medium text-sm midday-text-primary">{title}</h3>
          {description && (
            <p className="text-muted-foreground text-sm midday-text-muted">{description}</p>
          )}
        </div>
      </>
    )}
