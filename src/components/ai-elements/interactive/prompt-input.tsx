...
export const PromptInput = ({
  ...
  return (
    <AttachmentsContext.Provider value={ctx}>
      ...
      <form
        className={cn(
          "w-full divide-y overflow-hidden midday-rounded-xl border midday-bg-card midday-shadow-sm",
          className
        )}
  ...
  return (
    <Textarea
      className={cn(
        ...
        "midday-font-sans text-sm text-foreground placeholder:text-muted-foreground",
        className
      )}
      name="message"
      onChange={(e) => {
